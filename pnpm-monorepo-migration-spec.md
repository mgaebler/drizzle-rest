...
This document outlines how to convert an existing single-package JavaScript/TypeScript project into a pnpm-managed monorepo, while keeping npm for package publishing.
